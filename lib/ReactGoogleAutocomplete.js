...
function ReactGoogleAutocomplete(props) {
  ...
  return /* @__PURE__ */ React.createElement("input", { ref, ...rest });
}
...
var ReactGoogleAutocomplete_default = forwardRef((props, ref) => /* @__PURE__ */ React.createElement(ReactGoogleAutocomplete, { ...props, refProp: ref }));
export {
  ReactGoogleAutocomplete_default as default
};
